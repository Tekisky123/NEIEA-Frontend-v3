                            ...
                            <div className="space-y-6">
                              <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                  ...
                                  {
                                    selectedDonorDetails.donations.length > 0 && (
                                      <>
                                        <div>
                                          <p className="text-sm text-ngo-rakau">
                                            <strong>Adress:</strong>{" "}
                                            {selectedDonorDetails.donations[0].address}
                                          </p>
                                        </div>
                                        <div>
                                          <p className="text-sm text-ngo-rakau">
                                            <strong>City :</strong>{" "}
                                            {selectedDonorDetails.donations[0].city}
                                          </p>
                                        </div>
                                        <div>
                                          <p className="text-sm text-ngo-rakau">
                                            <strong>State :</strong>{" "}
                                            {selectedDonorDetails.donations[0].state}
                                          </p>
                                        </div>
                                        <div>
                                          <p className="text-sm text-ngo-rakau">
                                            <strong>Zip Code :</strong>{" "}
                                            {selectedDonorDetails.donations[0].zipCode}
                                          </p>
                                        </div>
                                        <div>
                                          <p className="text-sm text-ngo-rakau">
                                            <strong>Country :</strong>{" "}
                                            {selectedDonorDetails.donations[0].country}
                                          </p>
                                        </div>
                                        <div>
                                          <p className="text-sm text-ngo-rakau">
                                        ...
                                        <div>
                                          <p className="text-sm text-ngo-rakau">
                                            <strong>Donor Type :</strong>{" "}
                                            {selectedDonorDetails.donations[0].donorType || 'Regular'}
                                          </p>
                                        </div>
                                        <div>
                                          <p className="text-sm text-ngo-rakau">
                                            <strong>Created At :</strong>{" "}
                                            {new Date(selectedDonorDetails.createdAt).toLocaleDateString()}
                                          </p>
                                        </div>

      ...
      <div className="container">
          ...
          <div className="col-md-6">
            <nav className="footer-navbar">
              <a title="logo" href="#" className="logo">
                <img src="/assets/images/secondary-logo.svg" alt="Indiaspora Logo" />
              </a>
        ...
        <div className="row footer-btm">
          <div className="col-md-6 p-0">
            <div className="copyright">© 2012-2024 Indiaspora, Inc. All rights reserved.</div>
          </div>
          <div className="col-md-6 p-0">
            <ul className="social-links">
              <li><a target="_blank" href="https://www.linkedin.com/company/indiasporaforum/" rel="noopener noreferrer">
              ...
              <li><a target="_blank" href="https://www.youtube.com/c/indiaspora" rel="noopener noreferrer">
              ...
              <li><a target="_blank" href="https://x.com/IndiasporaForum" rel="noopener noreferrer">
              ...
              <li><a target="_blank" href="https://www.instagram.com/indiaspora/?hl=en" rel="noopener noreferrer">
              ...
              <li><a target="_blank" href="https://www.facebook.com/IndiasporaForum" rel="noopener noreferrer">
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">

    ...
    <section className="banner">
      <div className="banner-body">
        <div className="owl-carousel owl-theme banner-car">
          <div className="item">
            <img className="main-img home-banner-desk" src="/assets/images/banner1.jpg" alt="Philanthropy Summit" />
            <img className="main-img home-banner-mob" src="/assets/images/banner1.jpg" alt="Philanthropy Summit" />
            <div className="container">
              <div className="ban-cont">
                <h2><span>EVENTS</span> Indiaspora-IPA Philanthropy Summit</h2>
                <p>The Summit will bring together visionary philanthropists, foundation leaders, and nonprofit changemakers dedicated to India-focused initiatives.</p>
          ...
          <div className="item">
            <img className="main-img home-banner-desk" src="/assets/images/banner2.jpg" alt="US Forum" />
            <img className="main-img home-banner-mob" src="/assets/images/banner2.jpg" alt="US Forum" />
            <div className="container">
              <div className="ban-cont">
                <h2><span>Events</span> Indiaspora US Forum</h2>
                <p>The Indiaspora US Forum convenes members for two days of connection, collaboration, and impact.</p>
                <a className="main-btn" href="#">
                  Explore More
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path d="M6 12H18" stroke="#06038F" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
          ...
          <div className="item">
            <img className="main-img home-banner-desk" src="/assets/images/banner3.jpg" alt="Impact Report" />

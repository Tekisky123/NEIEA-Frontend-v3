...
export const coursesCategory = [
    ...
    { id: 5, name: "Technical Courses", slug: "technical", path: "/courses/technical" },
    { id: 6, name: "Financial & Literacy Courses", slug: "financial-literacy", path: "/courses/financial-literacy" },
    { id: 7, name: "NIOS Courses", slug: "nios", path: "/courses/nios" },
    { id: 8, name: "CBSE Courses", slug: "cbse", path: "/courses/cbse" }
];
